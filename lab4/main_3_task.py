...
heart = ((80, 0), (0,0))
#heart = ((80, 0), (-80, 0),(0, -80),(0, 80), (80, 0))


robot = linear_controller(heart[0],(60,100))
...
sleep(3) 
robot = linear_controller(heart[1],(60,100))
dist = robot.get_distance((80, 0))
...
# robot = linear_controller(heart[2],(60,100))
# dist = robot.get_distance((0, -80))
...
# robot = linear_controller(heart[3],(60,100))
# dist = robot.get_distance((-80, 0))
...
# robot = linear_controller(heart[4],(60,100))
# dist = robot.get_distance((0, 80))
